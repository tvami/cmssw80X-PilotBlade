...
config.General.requestName = 'PilotBlade_data_Ntuplizer_pA_Runs286520_CMSSW8023_RAW_FiduAlign_ROC6_Margin20_AlignAgain_v1'
config.General.transferOutputs = True
config.General.transferLogs = True

config.section_('JobType')
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '3ppReco2Ntuple_CMSSW80X_TrackerZminusOnly_Fidu_ROC6.py'
